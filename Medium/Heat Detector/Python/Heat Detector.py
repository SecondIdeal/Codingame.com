...
bulding_width, bulding_height           = [int(i) for i in raw_input().split()]
max_turns_before_game_over              = int(raw_input())
batman_position_X, batman_position_Y    = [int(i) for i in raw_input().split()]
...
while True:
    bomb_direction_from_current_location = raw_input()  # U, UR, R, DR, D, DL, L or UL
